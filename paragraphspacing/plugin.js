tinymce.PluginManager.add('paragraphspacing', function(editor, url) {
  ...
  const paragraphspacingOptions = editor.getParam('paragraphspacing_options', {
    fillStyle: 'inherit',
    strokeStyle: 'inherit',
    strokeWidth: 'inherit'
  });
